...
supports the role, which is the question a digest is asking.

**The ledger decides what is new, not a timestamp.** The first design selected "jobs
first seen since the last digest". Alongside a 25-a-day cap, that is a data
...
**Age comes only from `posted_at`.** Project rule: "First seen is never a posting date."
